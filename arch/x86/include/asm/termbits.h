 ...
 */
/* Some stuffs are still in tty driver. */
#ifndef __ASM_X86_TERMBITS_H
#define __ASM_X86_TERMBITS_H
...
/* Here are the local extensions to the POSIX standard for Nucleos. Posix
