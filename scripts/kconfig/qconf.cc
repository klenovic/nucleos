	...
	: searchWindow(0)
{
	...
	snprintf(title, sizeof(title), _("Nucleos Kernel v%s Configuration"),
...
{
	static const QString str = _("Welcome to the qconf graphical kernel configuration tool for Nucleos.\n\n"
