...
#define NO_BIT		(0)	/* returned by alloc_bit() to signal failure */

#define LOOK_UP		0	/* tells search_dir to lookup string */
#define ENTER		1	/* tells search_dir to make dir entry */
#define DELETE		2	/* tells search_dir to delete entry */
#define IS_EMPTY	3	/* tells search_dir to ret. 0 or ENOTEMPTY */
...
#define SUPER_SIZE	usizeof (struct ext2_super_block) /* sb size in RAM */
...
/* size with padding */
#define DIR_ENTRY_ACTUAL_SIZE(d)				\
	(DIR_ENTRY_CONTENTS_SIZE(d) +				\
...
#define SUPPORTED_RO_COMPAT_FEATURES	(RO_COMPAT_SPARSE_SUPER | RO_COMPAT_LARGE_FILE)
