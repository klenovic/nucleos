...
static int remove_dir(struct inode *rldirp, struct inode *rip, char dir_name[NAME_MAX + 1]);
static int unlink_file(struct inode *dirp, struct inode *rip, char file_name[NAME_MAX + 1]);
