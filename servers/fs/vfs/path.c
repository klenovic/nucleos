...
static int lookup(struct vnode *dirp, int flags,
				 node_details_t *node);

/*===========================================================================*
 *				advance					     *
 *===========================================================================*/
struct vnode *advance(dirp, flags)
struct vnode *dirp;
int flags;
{
 ...
 *				lookup					     *
 *===========================================================================*/
static int lookup(start_node, flags, node)
