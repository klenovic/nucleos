...
void  hermes_struct_init(hermes_t * hw, u32_t address, int io_space, int reg_spacing);
...
int  hermes_write_ltv(hermes_t * hw, int bap, u16_t rid, u16_t length, const void *value);
int  hermes_present(hermes_t * hw);
int  myfunc_read(vir_bytes src);
void myfunc_write(vir_bytes dst, int val);
void hermes_print_ioarea(hermes_t * hw, int first_reg, int last_reg);
