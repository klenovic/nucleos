...
typedef void (*dp_user2nicf_t)(struct dpeth *dep, struct iovec_dat *iovp, vir_bytes offset,
			       int nic_addr, vir_bytes count);
typedef void (*dp_user2nicf_s_t)(struct dpeth *dep, struct iovec_dat_s *iovp, vir_bytes offset,
				 int nic_addr, vir_bytes count);
typedef void (*dp_nic2userf_t)(struct dpeth *dep, int nic_addr, struct iovec_dat *iovp,
			      vir_bytes offset, vir_bytes count);
typedef void (*dp_nic2userf_s_t)(struct dpeth *dep, int nic_addr, struct iovec_dat_s *iovp,
	      vir_bytes offset, vir_bytes count);
#if 0
typedef void (*dp_getheaderf_t)(struct dpeth *dep, int page, struct dp_rcvhdr *h, u16_t *eth_type);
#endif
