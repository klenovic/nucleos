 ...
 *    m_data1:	PR_ENDPT	(parent, process that forked)
 *    m_data2:	PR_SLOT		(child's process table slot)
 *    m_data4:	PR_MEM_PTR	(new memory map for the child)
 *    m_data3:	PR_FORK_FLAGS	(fork flags)
 */
